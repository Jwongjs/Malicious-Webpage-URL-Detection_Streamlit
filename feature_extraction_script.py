...
def extract_url_features(input_url):
    urls_df = pd.DataFrame({"url":[input_url]})
    ...
    def get_url_region(primary_domain):
        ccTLD_to_region = {
            ...
            ".bw": "Botswana", ".by": "Belarus", ".bz": "Belize", ".ca": "Canada", ".cc": "Cocos Islands", ".cd": "Democratic Republic of the Congo", 
            ...
            ".eg": "Egypt", ".er": "Eritrea", ".es": "Spain", ".et": "Ethiopia", ".eu": "European Union", ".fi": "Finland", ".fj": "Fiji", 
            ...
            ".gy": "Guyana", ".hk": "Hong Kong", ".hm": "Heard Island and McDonald Islands", ".hn": "Honduras", ".hr": "Croatia", ".ht": "Haiti", 
            ...
            ".km": "Comoros", ".kn": "Saint Kitts and Nevis", ".kp": "Democratic People's Republic of Korea (North Korea)", 
            ".kr": "Republic of Korea (South Korea)", ".kw": "Kuwait", ".ky": "Cayman Islands", ".kz": "Kazakhstan", ".la": "Laos", 
            ...
            ".me": "Montenegro", ".mf": "Saint Martin (French part)", ".mg": "Madagascar", ".mh": "Marshall Islands", ".mk": "North Macedonia", 
            ...
            ".sx": "Sint Maarten (Dutch part)", ".sy": "Syria", ".sz": "Eswatini", ".tc": "Turks and Caicos Islands", ".td": "Chad", 
    ...
    urls_df['secondary_domain'] = urls_df['primary_domain'].apply(lambda x: extract_secondary_domain(str(x)))
    ...
    urls_df['secondary_domain'] = urls_df['secondary_domain'].apply(hash_encode)
