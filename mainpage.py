...
st.set_page_config(page_title="URL Classification", page_icon="🛡️", layout="wide")
...
def page_intro_section():
    ...
    with col1:
        ...
        st.subheader("Reveal what’s behind the URL — identify threats, scams, and unsafe content with AI-powered classification. 🤖")
    with col2:
...
def url_input_section():
    url = st.text_input("#### Insert the web address ⬇️", placeholder="http://maliciouswebsitetest.com")
...
button_clicked = st.button("🔍 Check URL")
        ...
        with st.spinner('Analyzing URL...'):
            try:
                ...
                if pred_label == "benign":
                    st.success("✅ Benign URL: This website appears to be safe")
                    threat_type = "Benign"
                elif pred_label == "defacement":
                    st.error("⚠️ Defacement Threat Detected!")
                    threat_type = "Defacement"
                elif pred_label == "malware":
                    st.error("☢️ Malware Threat Detected!")
                    threat_type = "Malware"
